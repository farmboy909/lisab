...
<div class="signin-form">
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <h2 class="form-signin-heading" style="color:0091f5">Dealer Registration</h2><hr />
		...
		if(isset($msg)){
			...
			?>
            <div class='alert alert-info' style="background-color:#0091F5">
        ...
        <center>Billing Information
          <input type="text" class="form-control" name="billBusname" id="billBusname" placeholder="Business Name" required  />
        </center>
        </div>
...
<script>
    ...
    if(pass1.value == pass2.value){
		...
		$(document).ready(function(){						//accept only dealer numbers that contain 2 caps and 4 nums 
			$('#dealer').blur(function () { 
   			 if(this.value = this.value.match(/[A-T]{2}[0-9]{4}/g)){
				}else{
